 ...
 */
class RobotComposerContextMenuProvider extends ContextMenuProvider 
{
	 ...
	 */
	public RobotComposerContextMenuProvider(EditPartViewer viewer, ActionRegistry registry)
	{
		super(viewer);
		if(registry == null)
		{
