...
/**
 * This is the item provider adapter for a {@link org.roboid.robot.Sensor} object.
 * <!-- begin-user-doc -->
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Sensor_throttle_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Sensor_throttle_feature", "_UI_Sensor_type"),
				 RobotPackage.Literals.SENSOR__THROTTLE,
				 false,
				 false,
				 false,
...
//		addReceptorsPropertyDescriptor(object);
	...
	protected void addProxyForPropertyDescriptor(Object object)
	{
		if(proxyForPropertyDescriptor == null)
		{
			...
			(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
					 getResourceLocator(),
					 getString("_UI_Sensor_proxyFor_feature"),
					 getString("_UI_PropertyDescriptor_description", "_UI_Sensor_proxyFor_feature", "_UI_Sensor_type"),
					 RobotPackage.Literals.SENSOR__PROXY_FOR,
					 true,
					 false,
					 true,
					 null,
	...
	protected void addReceptorsPropertyDescriptor(Object object)
	{
		if(receptorsPropertyDescriptor == null)
		{
			...
			(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Sensor_receptors_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Sensor_receptors_feature", "_UI_Sensor_type"),
				 RobotPackage.Literals.SENSOR__RECEPTORS,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object)
	{
		if(((Device)object).isProxy())
			return getText(object, "_UI_Sensor_type");
		else
			return getText(object, "_UI_Sensor_type") + getReceptorText(object);
	}
	...
	public Object getImage(Object object)
	{
		if(object instanceof Device && ((Device)object).isProxy())
			return overlayImage(object, getResourceLocator().getImage("full/obj16/Sensor_Proxy"));
		else
	...
	{
		return overlayImage(object, getResourceLocator().getImage("full/obj16/Sensor.png"));
	}
}
