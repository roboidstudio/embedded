...
class CloneContent extends AbstractClip
{
	...
	private ContentClip originalClip; // 원본 클립
	
	private transient org.roboid.studio.contentscomposer.MotionContentCloneBlock newNode;
	
	public org.roboid.studio.contentscomposer.MotionContentCloneBlock toVersion1_4(org.roboid.studio.contentscomposer.MotionContent parent, Robot robot)
	{
	...
	{
		int index = getParentDiagram().getContentClips().indexOf(originalClip);
