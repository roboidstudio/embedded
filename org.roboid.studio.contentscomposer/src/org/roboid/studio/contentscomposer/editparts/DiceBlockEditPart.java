 ...
 */
public class DiceBlockEditPart extends BlockElementWithLabelEditPart
{
	private static final String IMAGE = "/icons/random.png";
		...
		BlockFigure figure = new BlockFigure(this)
		{
			...
			protected void fillShape(Graphics g)
			{
				...
				if(getCastedModel().getScriptType() == ScriptType.NONE)
					timeout = Integer.toString(getCastedModel().getRange());
				else
					timeout = "rs";
				g.drawText(timeout, x + 22, y + 5);
			}
		};
		figure.setSize(48, 24);
//		figure.addMouseListener(new ScriptEditor(this));
		return figure;
	}	
	
	private DiceBlock getCastedModel()
	{
		return (DiceBlock)getModel();
	}
}
