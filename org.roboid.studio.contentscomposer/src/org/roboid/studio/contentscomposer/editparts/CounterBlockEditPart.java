 ...
 */
public class CounterBlockEditPart extends BlockElementWithLabelEditPart
{
	private static final String IMAGE = "/icons/loop.png";
		...
		BlockFigure figure = new BlockFigure(this)
		{
			...
			protected void fillShape(Graphics g)
			{
				...
				if(getCastedModel().getScriptType() == ScriptType.NONE)
					countout = Integer.toString(getCastedModel().getCount());
				else
					countout = "rs";
				g.drawText(countout, x + 22, y + 5);
			}			
		};
	...
	private LoopBlock getCastedModel()
	{
		return (LoopBlock)getModel();
	}
}
