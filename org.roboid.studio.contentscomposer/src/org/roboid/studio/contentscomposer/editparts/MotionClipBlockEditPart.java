 ...
 */
public class MotionClipBlockEditPart extends BlockElementEditPart
{
	private static final String IMAGE = "/icons/motion.png";
	...
	private MotionClipBlock getCastedModel()
	{
		return (MotionClipBlock)getModel();
	}
}
