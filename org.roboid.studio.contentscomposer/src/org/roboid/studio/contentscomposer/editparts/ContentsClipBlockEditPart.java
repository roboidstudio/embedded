 ...
 */
public class ContentsClipBlockEditPart extends BlockElementEditPart
{
	private static final String IMAGE = "/icons/mcc.png";
	...
	protected IFigure createFigure()
	{
		...
		BlockFigure figure = new BlockFigure(this)
		{
			...
			protected void fillShape(Graphics g)
			{
				...
				// 클립의 이름을 내부에 표시한다.
				g.drawText(getCastedModel().getName(), x + 20, y + 5);
			}			
		};
	...
	private MotionContentBlock getCastedModel()
	{
		return (MotionContentBlock)getModel();
	}
}
