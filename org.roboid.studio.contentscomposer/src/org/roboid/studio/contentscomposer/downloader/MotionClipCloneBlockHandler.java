 ...
 */
final class MotionClipCloneBlockHandler extends AbstractBlockHandler
{
	MotionClipCloneBlockHandler(Context context, String prefix, BlockElement block)
	{
		super(context, prefix, "MotionClipClone", block);
	}

	@Override
	void createFunctionCode(Context context, StringBuilder sb)
	{
		MotionClipCloneBlock block = (MotionClipCloneBlock)getBlock();
