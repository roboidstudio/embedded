 ...
 */
final class RootBlockHandler extends AbstractBlockHandler
{
	RootBlockHandler(Context context, String prefix, BlockElement block)
	{
		super(context, prefix, "Root", block);
	}

	@Override
	void createFunctionCode(Context context, StringBuilder sb)
	{
		RootBlock block = (RootBlock)getBlock();
