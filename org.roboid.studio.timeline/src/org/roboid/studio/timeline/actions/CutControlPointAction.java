...
import org.roboid.studio.timeline.commands.CutControlPointCommand;
import org.roboid.studio.timeline.editparts.ControlPointEditPart;

/**
 * @author Kwang-Hyun Park
 */
public class CutControlPointAction extends SelectionAction
{
	public CutControlPointAction(IWorkbenchPart part)
	{
		super(part);
	...
	public void run()
	{
		...
		execute(new CutControlPointCommand(points));
	}
}
