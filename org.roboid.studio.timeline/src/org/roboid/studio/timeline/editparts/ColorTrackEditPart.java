 ...
 */
public class ColorTrackEditPart extends ChannelTrackEditPart
{
	// 채널의 배경색을 얻는다.
	// ColorLedChannel과 DualLedChannel은 초록색
	@Override
	...
	{
		ColorPoint cp = TimelineFactory.eINSTANCE.createColorPoint();
...
//		TimelineEditor.commandStack.execute(command);
	...
	@Override
	public ColorTrack getModel()
	{
		return (ColorTrack)super.getModel();
	}
}
