 ...
 */
public class TextTrackEditPart extends ChannelTrackEditPart
{
	@Override
	...
	{
		TextPoint cp = TimelineFactory.eINSTANCE.createTextPoint();
...
//		TimelineEditor.commandStack.execute(command);
	...
	@Override
	public TextTrack getModel()
	{
		return (TextTrack)super.getModel();
	}
}
