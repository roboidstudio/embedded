...
public class MotionClipStreamExportOperation implements IRunnableWithProgress
{
	private IPath path;
	private IProgressMonitor monitor;
	private MotionClipStreamExporter exporter = new MotionClipStreamExporter();
	...
	public MotionClipStreamExportOperation(IResource res, String destinationPath, IOverwriteQuery overwriteImplementor)
	{
		super();
		resource = res;
	...
	@SuppressWarnings("rawtypes")
	public MotionClipStreamExportOperation(IResource res, List resources, String destinationPath, IOverwriteQuery overwriteImplementor)
	{
	...
	protected void exportFile(IFile file, IPath location) throws InterruptedException
	{
		...
		fileName = fileName.substring(0, dot) + ".mcs";
