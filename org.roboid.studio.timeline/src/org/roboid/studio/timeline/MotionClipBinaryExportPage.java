...
public class MotionClipBinaryExportPage extends WizardExportResourcesPage implements Listener
{
	...
	private static final String STORE_DESTINATION_NAMES_ID = "MotionClipBinaryExportPage.STORE_DESTINATION_NAMES_ID"; //$NON-NLS-1$
	private static final String STORE_OVERWRITE_EXISTING_FILES_ID = "MotionClipBinaryExportPage.STORE_OVERWRITE_EXISTING_FILES_ID"; //$NON-NLS-1$
	private static final String STORE_CREATE_STRUCTURE_ID = "MotionClipBinaryExportPage.STORE_CREATE_STRUCTURE_ID"; //$NON-NLS-1$
	...
	protected MotionClipBinaryExportPage(String name, IStructuredSelection selection)
	{
	...
	protected boolean executeExportOperation(MotionClipBinaryExportOperation op)
	{
	...
	public boolean finish()
	{
		...
		return executeExportOperation(new MotionClipBinaryExportOperation(null, resourcesToExport, getDestinationValue(), this));
	}
