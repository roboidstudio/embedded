...
/**
 * This is the item provider adapter for a {@link org.roboid.robot.Channel} object.
 * <!-- begin-user-doc -->
		...
		IItemPropertySource
{
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Channel_devices_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Channel_devices_feature", "_UI_Channel_type"),
				 RobotPackage.Literals.CHANNEL__DEVICES,
				 true,
				 false,
				 true,
				 null,
	...
	private void checkName(Notification notification)
	{
		if(notification.getEventType() == Notification.SET)
		{
			...
			Control parent = (Control)((EObject)channel).eContainer();
			setUniqueName(channel, newName, parent.getChannels());
		}
	}
}
