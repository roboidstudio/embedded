...
/**
 * This is the item provider adapter for a {@link org.roboid.robot.AudioChannel} object.
 * <!-- begin-user-doc -->
		...
		IItemPropertySource
{
	...
	{
		String label = ((AudioChannel)object).getName();
	...
	{
		return overlayImage(object, getResourceLocator().getImage("full/obj16/AudioChannel.png"));
	}
}
