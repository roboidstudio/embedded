...
/**
 * This is the item provider adapter for a {@link org.roboid.robot.Port} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PortItemProvider
	extends ChannelDeviceItemProvider
	implements
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Port_mode_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Port_mode_feature", "_UI_Port_type"),
				 RobotPackage.Literals.PORT__MODE,
				 true,
				 false,
				 false,
	...
	protected void addProxyForPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Port_proxyFor_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Port_proxyFor_feature", "_UI_Port_type"),
				 RobotPackage.Literals.PORT__PROXY_FOR,
				 true,
				 false,
				 true,
				 null,
