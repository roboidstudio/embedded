...
public class Identifier
{
	...
	private static String[] keywords = 
		...
		"encodeURI", "Error", "escape", "evel",
		"EvalError", "Function", "Infinity",
		"isFinity", "isNaN", "Math", "NaN", 
		"Number", "Object", "parseFloat",
		"parseInt", "parseError", "RangeError",
	...
	public static StyleRange createStyle(Shell shell, int start, int end)
	{
		...
		style.foreground = shell.getDisplay().getSystemColor(SWT.COLOR_DARK_MAGENTA);
		return style;
	}
}
